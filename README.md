...
### 2026-
* Andhra Pradesh districts (update of districts reorg w.e.f 31 Dec 2025): apdistricts/ (Some  base layers are from apdistrict-osm/)
...
### 2024-
* OSM data (via geojson)
* Natural earth
### 2020-2022
* OSM data (via shape files)
* Natural earth
